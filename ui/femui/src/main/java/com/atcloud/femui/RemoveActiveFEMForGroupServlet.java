 ...
 * @version $Revision: $
 */
public class RemoveActiveFEMForGroupServlet extends AbstractHttpServlet {

	/**
	 * 
	 */
	public static final Logger LOG = LoggerFactory
			.getLogger(RemoveActiveFEMForGroupServlet.class.getName());
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			femService.setActiveFEMForGroup(groupName, femName);
