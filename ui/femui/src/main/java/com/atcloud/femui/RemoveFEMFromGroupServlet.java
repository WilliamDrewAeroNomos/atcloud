 ...
 * @version $Revision: $
 */
public class RemoveFEMFromGroupServlet extends AbstractHttpServlet {

	/**
	 * 
	 */
	public static final Logger LOG = LoggerFactory
			.getLogger(RemoveFEMFromGroupServlet.class.getName());
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			femService.removeFEMFromGroup(femName, groupName);
