 ...
 * @version $Revision: $
 */
public class GetFederatesInFEMServlet extends AbstractHttpServlet {

	/**
	 * 
	 */
	public static final Logger LOG = LoggerFactory
			.getLogger(GetFederatesInFEMServlet.class.getName());
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			List<Federate> federates = femService.getFederatesInFEM(femName);
