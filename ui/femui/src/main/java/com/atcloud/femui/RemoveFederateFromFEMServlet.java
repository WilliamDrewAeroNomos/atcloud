 ...
 * @version $Revision: $
 */
public class RemoveFederateFromFEMServlet extends AbstractHttpServlet {

	/**
	 * 
	 */
	public static final Logger LOG = LoggerFactory
			.getLogger(RemoveFederateFromFEMServlet.class.getName());
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			femService.removeFederateFromFEM(federateName, femName);
