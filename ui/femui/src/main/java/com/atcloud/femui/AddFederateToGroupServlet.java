 ...
 * @version $Revision: $
 */
public class AddFederateToGroupServlet extends AbstractHttpServlet {

	/**
	 * 
	 */
	public static final Logger LOG = LoggerFactory
			.getLogger(AddFederateToGroupServlet.class.getName());
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			femService.addFederateToGroup(federateName, groupName);
