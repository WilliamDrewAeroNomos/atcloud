 ...
 * @version $Revision: $
 */
public class GetActiveFEMForGroupServlet extends AbstractHttpServlet {

	/**
	 * 
	 */
	public static final Logger LOG = LoggerFactory
			.getLogger(GetActiveFEMForGroupServlet.class.getName());
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			FEM fem = femService.getActiveFEMForGroup(groupName);
