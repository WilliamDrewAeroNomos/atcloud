 ...
 * @version $Revision: $
 */
public class AddFederateToFEMServlet extends AbstractHttpServlet {

	/**
	 * 
	 */
	public static final Logger LOG = LoggerFactory
			.getLogger(AddFederateToFEMServlet.class.getName());
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		String federateName = req.getParameter(ServiceEndPointArgumentNames.FEDERATE_NAME.getArgName());
		String femName = req.getParameter(ServiceEndPointArgumentNames.FEM_NAME.getArgName());

		try {

			femService.addFederateToFEM(federateName, femName);
