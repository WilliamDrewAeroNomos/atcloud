 ...
 * @version $Revision: $
 */
public class GetFEMByNameServlet extends AbstractHttpServlet {

	/**
	 * 
	 */
	public static final Logger LOG = LoggerFactory
			.getLogger(GetFEMByNameServlet.class.getName());
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		String femName =
				req.getParameter(ServiceEndPointArgumentNames.FEM_NAME.getArgName());

		try {

			FEM fem = femService.getFEM(femName);

			ServletOutputStream os = resp.getOutputStream();

			os.println(String.format("%s", (fem == null) ? "" : fem.toString()));
